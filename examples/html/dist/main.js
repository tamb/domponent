...
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class Counter extends domponent__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(conf) {
    super(conf);
    this.state = {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DisplayAnything; });
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class DisplayAnything extends domponent__WEBPACK_IMPORTED_MODULE_0__["Exponent"] {
  constructor(el) {
    super(el);
    this.displayProps();
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FavoriteShow; });
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class FavoriteShow extends domponent__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(el) {
    super(el);
    this.state = {
      show: "Thomas"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return HoverLetter; });
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class HoverLetter extends domponent__WEBPACK_IMPORTED_MODULE_0__["Exponent"] {
  constructor(conf) {
    super(conf);
...
class Navigation extends domponent__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(conf) {
    super(conf);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ShowCode; });
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class ShowCode extends domponent__WEBPACK_IMPORTED_MODULE_0__["Exponent"] {
  constructor(conf) {
    super(conf);
    this.styleID =  "collapse-comp-styles";
    if (!document.getElementById(this.styleID)) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CurrentTime; });
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);


class CurrentTime extends domponent__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(el) {
    super(el);
    this.state = {
      hours: "",
...
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! domponent */ "./node_modules/domponent/dist/domponent.development.js");
/* harmony import */ var domponent__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(domponent__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Counter_Counter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Counter/Counter */ "./src/Counter/Counter.js");
/* harmony import */ var _Timer_Timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Timer/Timer */ "./src/Timer/Timer.js");
/* harmony import */ var _DisplayAnything_DisplayAnything__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DisplayAnything/DisplayAnything */ "./src/DisplayAnything/DisplayAnything.js");
/* harmony import */ var _FavoriteShow_FavoriteShow__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./FavoriteShow/FavoriteShow */ "./src/FavoriteShow/FavoriteShow.js");
/* harmony import */ var _HoverLetter_HoverLetter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./HoverLetter/HoverLetter */ "./src/HoverLetter/HoverLetter.js");
/* harmony import */ var _Navigation_Navigation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Navigation/Navigation */ "./src/Navigation/Navigation.js");
/* harmony import */ var _ShowCode_ShowCode__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ShowCode/ShowCode */ "./src/ShowCode/ShowCode.js");
/* harmony import */ var _domInsert__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./domInsert */ "./src/domInsert.js");
...
const App = new domponent__WEBPACK_IMPORTED_MODULE_0__["Init"]({
  ...
  components: {
    ...
    DisplayAnything: _DisplayAnything_DisplayAnything__WEBPACK_IMPORTED_MODULE_3__["default"],
    FavoriteShow: _FavoriteShow_FavoriteShow__WEBPACK_IMPORTED_MODULE_4__["default"],
    HoverLetter: _HoverLetter_HoverLetter__WEBPACK_IMPORTED_MODULE_5__["default"],
    Navigation: _Navigation_Navigation__WEBPACK_IMPORTED_MODULE_6__["default"],
