  ...
  function(t, e, s) {
    !(function(t) {
      ...
      const e = {
        ...
        n = { ONCE: "once", PASSIVE: "passive", CAPTURE: "capture" };
      class o {
        constructor(t) {
          (this.$root = t.element),
            (this.$app = t.app),
            (this.$key = t.key),
            (this.$name = t.element.getAttribute(
...
<<<<<<< HEAD
      ...
      function r(t) {
        return t.trim().split(s.MULTIPLE_VALUES);
      }
      function c(t) {
        return t.trim().split(s.FROM_COMPONENT);
      }
      function p() {
        (this.$b = []),
...
>>>>>>> rebase to master
                ...
                const i = this[r[1]].bind(this);
                t.addEventListener(a, i, e),
                  o.actions.push({ event: a, handler: i, options: e });
              }
            }, this),
              this.$b.push(o);
          }, this);
...
>>>>>>> rebase to master
        this.$d.forEach(e => {
          (function(t) {
            ...
            for (let e in this.$p) {
              const s = this.$p[e];
              t.includes(this.$p[e].parentComponentKey) &&
                ((this.props[e] =
                  s.parentComponent.state[s.parentComponentKey]),
                this.$p[e].els &&
                  this.$p[e].els.forEach(t => {
...
>>>>>>> rebase to master
              ...
              if (t.length > 0) {
                ...
                return (
                  t.forEach(t => {
                    const s = {};
                    r(
                      t.getAttribute(`data-${this.$app.$datasets.bind}`)
                    ).forEach(n => {
                      var o = c(a(n)[1])[1];
            ...
            function() {
              const t = this.$root.getAttribute(
                `data-${this.$app.$datasets.state}`
              );
              t && this.setState(JSON.parse(t));
            }.call(this),
            this.connected();
        }
        stateWillUpdate() {}
        ...
        (t.Init = function(t) {
          return (
            ...
            (this.$datasets = (() => {
              const s = e;
              if (t.dataAttributes)
                for (let e in t.dataAttributes) s[e] = t.dataAttributes[e];
              return s;
            })()),
            (this._cc = (e, s) => {
              const n =
                e.getAttribute(`data-${this.$datasets.key}`) ||
              ...
              (this.registeredComponents[n] = new t.components[
                e.getAttribute(`data-${this.$datasets.component}`)
              ]({ element: e, key: n, app: this })),
                s && s();
            }),
            (this._dc = (t, e) => {
              this.registeredComponents[t].disconnecting(),
                function() {
                  this.$b.forEach(t => {
                    console.log("binding", t),
                      t.actions.forEach(e => {
                        t.el.removeEventListener(e.event, e.handler, e.options);
                      }, this);
                  }, this);
                }.call(this.registeredComponents[t]),
...
>>>>>>> rebase to master
    ...
    const o = new n.Init({
      ...
      components: {
        Counter: class extends n.Component {
          constructor(t) {
            super(t),
              (this.state = {
          ...
          increment(t) {
            const e = {},
              s = parseInt(this.state.count + 1, 10);
            (e.count = s),
              (e.isEven = s % 2 == 0),
              this.setState(e, () => console.log("Single Callback", this));
          }
          decrement(t) {
            const e = {},
              s = parseInt(this.state.count - 1, 10);
            (e.count = s), (e.isEven = s % 2 == 0), this.setState(e);
          }
          goBlue(t) {
            t.target.style.color = "blue";
          }
          goGreen(t) {
        ...
        Timer: class extends n.Component {
          constructor(t) {
            super(t),
              (this.state = { hours: "", seconds: "", minutes: "" }),
              setInterval(() => {
                this.changeTime();
              }, 1e3);
          }
        ...
        DisplayAnything: class extends n.Exponent {
          constructor(t) {
            super(t), this.displayProps();
          }
          propsDidUpdate() {
            this.displayProps();
          }
        ...
        FavoriteShow: class extends n.Component {
          constructor(t) {
            super(t), (this.state = { show: "Thomas" });
          }
          handleInput(t) {
            console.log(t), this.setState({ show: t.target.value });
          }
          stateDidUpdate() {
            this.secondInput.value = this.state.show;
          }
        },
        HoverLetter: class extends n.Exponent {
          constructor(t) {
            super(t), (this.styleID = "hover-letter__style"), this.splitWord();
          }
          splitWord() {
            let t = this.letters.textContent
                .toString()
                .split("")
                .map(t => `<span tabindex="0" class="hoverable">${t}</span>`),
              e = "";
            t.forEach(t => (e += t)),
              (this.letters.innerHTML = ""),
              (this.letters.innerHTML = e),
              document.getElementById(this.styleID) || this.placeStyles();
          }
          placeStyles() {
...
>>>>>>> rebase to master
    ...
    console.timeEnd("appCreation"),
      (window.DomponentApp = o),
      setTimeout(() => {
        !(function(t) {
          const e = document.getElementById("async"),
            s = Math.floor(100 * Math.random()),
            n = `\n    <div class="col-md-6">\n    <div id="${t}" data-component="Counter" class="card" data-state='{"count":${s},"isEven":${s %
              2 ==
          ...
          o.createComponent(document.getElementById("id2"), () =>
            feather.replace()
          ),
          o.createComponent(document.getElementById("async-props"), () =>
            feather.replace()
          );
      }, 1e3);
  }
